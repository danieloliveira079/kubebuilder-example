...
import (
	...
	operator_v1beta1 "github.com/danieloliveira079/kubebuilder-example/pkg/apis/operator/v1beta1"
	versioned "github.com/danieloliveira079/kubebuilder-example/pkg/client/clientset/versioned"
	internalinterfaces "github.com/danieloliveira079/kubebuilder-example/pkg/client/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/danieloliveira079/kubebuilder-example/pkg/client/listers/operator/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OperatorV1beta1().Medusas(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OperatorV1beta1().Medusas(namespace).Watch(options)
			},
		},
		&operator_v1beta1.Medusa{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *medusaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&operator_v1beta1.Medusa{}, f.defaultInformer)
}

func (f *medusaInformer) Lister() v1beta1.MedusaLister {
	return v1beta1.NewMedusaLister(f.Informer().GetIndexer())
}
